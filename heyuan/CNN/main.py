...
train_df = pd.read_csv('../ARIMA/train_FD001.txt', sep=" ", header=None)  # train_dr.shape=(20631, 28)
...
test_df = pd.read_csv('../ARIMA/test_FD001.txt', sep=" ", header=None)
test_df.drop(test_df.columns[[26, 27]], axis=1, inplace=True)
test_df.columns = ['id', 'cycle', 'setting1', 'setting2', 'setting3', 's1', 's2', 's3', 's4', 's5',
                   's6', 's7', 's8', 's9', 's10', 's11', 's12', 's13', 's14', 's15', 's16', 's17',
                   's18', 's19', 's20', 's21']

truth_df = pd.read_csv('../ARIMA/RUL_FD001.txt', sep=" ", header=None)
